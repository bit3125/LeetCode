...
| -------- | ---------------------------------------- | ---------- | --------- | ------------ | ---------------------------------------- | ---------------------------------------- |
| 55       | [Jump Game](https://leetcode.com/problems/jump-game) |            | √`        | √            | 亦可回溯                                     | 使用的是dp, 其实是On^2的复杂度，但是由于添加了一个break剪枝，所以时间竟然比R1使用的On的标记法还短。其实最优解是那个 |
| 11       | [Container With Most Water](https://leetcode.com/problems/container-with-most-water) |            | √`        | √`           |                                          | 游标的初始状态很重要                               |
...
| 287      | [Find the Duplicate Number](https://leetcode.com/problems/find-the-duplicate-number) |            | √         | √            | 剑指offer原题                                | num = range+1                            |
...
| 217      | [Contains Duplicate](https://leetcode.com/problems/contains-duplicate) | Easy       | √         | 不做           |                                          |                                          |
